            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId())
                {
                    case  R.id.nav_home:
                        ...
                        Intent intent = new Intent(about_us.this, sayfaiki.class);
                    ...
                    case  R.id.about_us:
                        ...
                        Intent b = new Intent(about_us.this, about_us.class);
                        startActivity(b);
                        break;

                    case  R.id.contact:

                        Intent y = new Intent(about_us.this, iletisim_sayfasi.class);
                        startActivity(y);
                        break;
